...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@SuppressWarnings("null") HttpServletRequest request, @SuppressWarnings("null") HttpServletResponse response, @SuppressWarnings("null") FilterChain chain)
        ...
        System.out.println("AAAAAAAAAAAAAAAAAAAAA"+authorizationHeader);
        ...
        System.out.println("eeeeeeeeeeeeeeeeeeeeeeeee"+username);
        ...
        chain.doFilter(request, response); // Asegúrate de que siempre se llama a chain.doFilter
    }
}
